export default function FeatureCard( {heading , paragraph}) {
  return (
    <div className="col-span-8 flex items-center justify-center pt-14">
      <div className="h-80 w-3/5 rounded-2xl border-2 border-yellow-400 text-slate-900 flex items-center justify-center drop shadow-xl flex-col px-10 bg-gradient-to-r from-rose-100 to-teal-100">
